...
const Footer = () => {
    return (
        <div className='container mx-auto'>
            <h1 id='contact-us' className='text-[3.5rem] text-center font-bold text-white drop-shadow-header mt-10 md:pb-14 pb-5  '>Contact Us</h1>
            <div className='flex md:flex-row flex-col md:justify-evenly px-10 md:items-center md:gap-0 gap-3 md:translate-x-0 translate-x-14'>
                ...
                <div className='flex flex-row gap-2 items-center text-white font-semibold'>
                    ...
                    <p className='text-[1.2rem]'>mriyasdeen1104@gmail.com</p>
                </div><div className='flex flex-row gap-2 items-center text-white font-semibold'>
